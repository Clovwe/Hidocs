  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: themeProvider.hasThemeImage
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _buildProfileCard(context, auth, themeProvider, isDark, user, l10n),
            ...
            _GroupCard(
              ...
              children: [
                ...
                _ThemeRow(
                  ...
                  onPickImage: () => _pickThemeImage(context, themeProvider),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [themeProvider.primary, themeProvider.primaryDark],
        ...
        boxShadow: [
          BoxShadow(
            color: themeProvider.primary.withValues(alpha: 0.35),
            blurRadius: 24,
  ...
  Future<void> _pickThemeImage(
    ...
    try {
      ...
      if (bytes == null || bytes.isEmpty) {
        throw Exception('Data gambar tidak dapat dibaca');
      }

      await themeProvider.setThemeImageBytes(bytes);

      if (!mounted) return;

      messenger.showSnackBar(
        SnackBar(content: Text(l10n.themeImagePicked)),
      );
    } catch (e) {
      if (!mounted) return;
...
class _EditProfileDialogState extends State<_EditProfileDialog> {
  ...
  Future<void> _save() async {
    ...
    await widget.auth.updateProfile(name: name, email: email);
...
class _ThemeRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final hasImage = themeProvider.hasThemeImage;
            ...
            children: [
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  icon: Icon(
                    hasImage ? Icons.image_outlined : Icons.upload_rounded,
                    size: 17,
                  ),
                  label: Text(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      onTap: () {
                        themeProvider.removeThemeImage();
                      },
                      borderRadius: BorderRadius.circular(20),
                      child: const Padding(
